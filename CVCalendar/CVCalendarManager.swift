...
public final class CVCalendarManager {
    ...
    public static func dateRange(_ date: Foundation.Date, calendar: Calendar) ->
    ...
    public static func componentsForDate(_ date: Foundation.Date, calendar: Calendar) -> DateComponents {
