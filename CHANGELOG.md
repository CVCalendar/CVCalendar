...
## [1.6.2](https://github.com/CVCalendar/CVCalendar/tree/1.6.2) (2018-12-13)
[Full Changelog](https://github.com/CVCalendar/CVCalendar/compare/1.6.1...1.6.2)

**Fixed bugs:**

- CalendarMode init with WeekView mode error [\#499](https://github.com/CVCalendar/CVCalendar/issues/499)
- Selected date disappears when changing orientation [\#485](https://github.com/CVCalendar/CVCalendar/issues/485)
- Calendar don't collapse correctly. Its happens once in ten or more [\#477](https://github.com/CVCalendar/CVCalendar/issues/477)
- Dots missplacing when switching displaying mode [\#109](https://github.com/CVCalendar/CVCalendar/issues/109)
- Week view not working properly [\#108](https://github.com/CVCalendar/CVCalendar/issues/108)
- Dot marker on current day appears above it, not below [\#87](https://github.com/CVCalendar/CVCalendar/issues/87)
- WeekView does not pick a day while switching between April and May [\#71](https://github.com/CVCalendar/CVCalendar/issues/71)

**Closed issues:**

- Week View firstWeekDay: Monday - ToggleViewWithDate does not scroll to next or previous week [\#539](https://github.com/CVCalendar/CVCalendar/issues/539)
- Printed month label is wrong [\#537](https://github.com/CVCalendar/CVCalendar/issues/537)
- Wrong month label  [\#536](https://github.com/CVCalendar/CVCalendar/issues/536)
- How can I deselect the date. [\#535](https://github.com/CVCalendar/CVCalendar/issues/535)
- I can't setup CVCalendar [\#533](https://github.com/CVCalendar/CVCalendar/issues/533)
- Selected day not highlighting when switching month on non-range selection [\#532](https://github.com/CVCalendar/CVCalendar/issues/532)
- Calling toggleViewWithDate\(\) sets DayViews which are unselectable to the selectable color [\#531](https://github.com/CVCalendar/CVCalendar/issues/531)
- Objective C support [\#530](https://github.com/CVCalendar/CVCalendar/issues/530)
- Calling refreshPresentedMonth doesn't remove previous dayViews [\#529](https://github.com/CVCalendar/CVCalendar/issues/529)
- Last or next month selection not properly selecting the date after navigating to the month. [\#528](https://github.com/CVCalendar/CVCalendar/issues/528)
- Strange look  at init of calendar  [\#527](https://github.com/CVCalendar/CVCalendar/issues/527)
- App crashes when I added a dotmarker [\#526](https://github.com/CVCalendar/CVCalendar/issues/526)
- How to prevent tapping on existing/next month dates? [\#525](https://github.com/CVCalendar/CVCalendar/issues/525)
- Removing separator lines in between the weekday names in month view [\#524](https://github.com/CVCalendar/CVCalendar/issues/524)
- Divide by zero exception when having CVCalendar as a subview of a toggle-able parent view [\#523](https://github.com/CVCalendar/CVCalendar/issues/523)
- Scrolling in weekly view going beyond the limited date \(checkScrollToPreviousDisabled\(\)  & checkScrollToBeyondDisabled\(\)\) need to be implemented in week view. [\#522](https://github.com/CVCalendar/CVCalendar/issues/522)
- How do I display the current month? [\#520](https://github.com/CVCalendar/CVCalendar/issues/520)
- Unimplemented Initializer [\#519](https://github.com/CVCalendar/CVCalendar/issues/519)
- Month name under the dates [\#518](https://github.com/CVCalendar/CVCalendar/issues/518)
- Calendar is not showing on iOS 10.x [\#517](https://github.com/CVCalendar/CVCalendar/issues/517)
- Is there a way to disable "disableDays" on selection? [\#515](https://github.com/CVCalendar/CVCalendar/issues/515)
- Day Specific Background Colors [\#514](https://github.com/CVCalendar/CVCalendar/issues/514)
- Autolayout for CVCalendarView and it's subviews [\#513](https://github.com/CVCalendar/CVCalendar/issues/513)
- How to customize each single dayview in CVCalendar for swift? [\#512](https://github.com/CVCalendar/CVCalendar/issues/512)
- sunday dates text are not in red color in some months  [\#509](https://github.com/CVCalendar/CVCalendar/issues/509)
- Question: How to improve the efficiency of dotMarker shouldShowOnDayView [\#506](https://github.com/CVCalendar/CVCalendar/issues/506)
- Question: How to improve the efficiency of dotMarker shouldShowOnDayView [\#505](https://github.com/CVCalendar/CVCalendar/issues/505)
- Cannot select a specific Date with a UI Test [\#504](https://github.com/CVCalendar/CVCalendar/issues/504)
- Is there any property to scroll calendar vertically already? [\#503](https://github.com/CVCalendar/CVCalendar/issues/503)
- Can I drag and drop elements to this calendar? [\#502](https://github.com/CVCalendar/CVCalendar/issues/502)
- Calendar does not relayout dates after change from weekView to monthView [\#500](https://github.com/CVCalendar/CVCalendar/issues/500)
- How to localize MenuView [\#498](https://github.com/CVCalendar/CVCalendar/issues/498)
- Wrong Date Print [\#497](https://github.com/CVCalendar/CVCalendar/issues/497)
- fatal error: unexpectedly found nil while unwrapping an Optional value [\#496](https://github.com/CVCalendar/CVCalendar/issues/496)
- show multiple color circle view on same calender moth view [\#495](https://github.com/CVCalendar/CVCalendar/issues/495)
- Not able to select a specific day when I shift in a new week, but it selects the current day automatically [\#486](https://github.com/CVCalendar/CVCalendar/issues/486)
- Month october not allow show previous month [\#481](https://github.com/CVCalendar/CVCalendar/issues/481)
- Toggling day from previous day when Monday is first day of the week in weekView presentationMode [\#476](https://github.com/CVCalendar/CVCalendar/issues/476)
- `disableScrollingBeforeDate\(\)` doesn't work, and `disableScrollingBeyondDate\(\)` doesn't work correctly. [\#474](https://github.com/CVCalendar/CVCalendar/issues/474)
- CVCalendarView days not matching CVMenuView upon screen rotation [\#441](https://github.com/CVCalendar/CVCalendar/issues/441)
- Option to enable all days in the past until today, rather than from today onwards [\#434](https://github.com/CVCalendar/CVCalendar/issues/434)
- i want to  setup selected day/today/other unselected day's  text color and backroundcolor [\#430](https://github.com/CVCalendar/CVCalendar/issues/430)
- func dotMarker\(shouldShowOnDayView dayView: DayView\) -\> Bool  “ this Method  in ios 10 Can display normally 。but is ios 9 can't display normally. and use “Debug view hierarchy” can see the dotmark.why??? [\#429](https://github.com/CVCalendar/CVCalendar/issues/429)
- Range select and scroll the view for next month -\> view greyed out   [\#407](https://github.com/CVCalendar/CVCalendar/issues/407)
- \[Feature Request\] Presenting each new month so the first day of month is in first position on calendar. [\#376](https://github.com/CVCalendar/CVCalendar/issues/376)
- CVDate equatable? [\#370](https://github.com/CVCalendar/CVCalendar/issues/370)
- Present weekday font does not change [\#351](https://github.com/CVCalendar/CVCalendar/issues/351)
- Put UIImageView on particular date. [\#341](https://github.com/CVCalendar/CVCalendar/issues/341)
- ToggleViewWithDate in week view working only if a date is selected once [\#330](https://github.com/CVCalendar/CVCalendar/issues/330)
- Supplementary Views Rendering on Wrong Days [\#324](https://github.com/CVCalendar/CVCalendar/issues/324)
- func dotMarker\(sizeOnDayView dayView: DayView\) -\> CGFloat is not called [\#313](https://github.com/CVCalendar/CVCalendar/issues/313)
- How do you call for the date to be unselected? [\#308](https://github.com/CVCalendar/CVCalendar/issues/308)
- I want to display TableView on supplementaryView for every day to list down events. [\#289](https://github.com/CVCalendar/CVCalendar/issues/289)
- CalendarView doesn't change when toggleViewWithDate [\#288](https://github.com/CVCalendar/CVCalendar/issues/288)
- calendarView.toggleViewWithDate has no effect if shouldAutoSelectDayOnMonthChange implements with return false [\#286](https://github.com/CVCalendar/CVCalendar/issues/286)
- Help Bring PreliminaryView to Calendar once App Opens and save it [\#285](https://github.com/CVCalendar/CVCalendar/issues/285)
- Setting presented date makes today's date fade out and fade in presented date [\#278](https://github.com/CVCalendar/CVCalendar/issues/278)
- Store selected days and then display them [\#274](https://github.com/CVCalendar/CVCalendar/issues/274)
- How do I call methods on viewWillAppear? \(E.g. shouldShowOnDayView, colorOnDayView, moveOffsetOnDayView\) [\#273](https://github.com/CVCalendar/CVCalendar/issues/273)
- Update after Event Changes [\#267](https://github.com/CVCalendar/CVCalendar/issues/267)
- Current date dotmaker appear on top of DayView. [\#266](https://github.com/CVCalendar/CVCalendar/issues/266)
- Coding style standards [\#262](https://github.com/CVCalendar/CVCalendar/issues/262)
- CVCalendar in TableViewCell [\#254](https://github.com/CVCalendar/CVCalendar/issues/254)
- Prevent Auto selection of day when swiping through months [\#253](https://github.com/CVCalendar/CVCalendar/issues/253)
- setup dotmarks [\#250](https://github.com/CVCalendar/CVCalendar/issues/250)
- How can I stop presentedDateUpdated from being called when a day is selected? [\#244](https://github.com/CVCalendar/CVCalendar/issues/244)
- Selecting a day in different month is not selected properly [\#243](https://github.com/CVCalendar/CVCalendar/issues/243)
- How to move the date label to the corner of DayView [\#241](https://github.com/CVCalendar/CVCalendar/issues/241)
- Today DotMark appeared on the top of dayview [\#240](https://github.com/CVCalendar/CVCalendar/issues/240)
- Calendar view popping into the correct position only after a scroll [\#238](https://github.com/CVCalendar/CVCalendar/issues/238)
- Limit months [\#233](https://github.com/CVCalendar/CVCalendar/issues/233)
- Change month in weekview [\#232](https://github.com/CVCalendar/CVCalendar/issues/232)
- How to get the weekday in the calendar & How to customize the selection of date? [\#230](https://github.com/CVCalendar/CVCalendar/issues/230)
- Selected date disappears if shouldAutoSelectDayOnMonthChange is false [\#215](https://github.com/CVCalendar/CVCalendar/issues/215)
- preliminaryView\(viewOnDayView dayView: DayView\) delegate being called twice [\#213](https://github.com/CVCalendar/CVCalendar/issues/213)
- Unable to simultaneously satisfy constraints. [\#212](https://github.com/CVCalendar/CVCalendar/issues/212)
- changeMode function doesn't do anything [\#210](https://github.com/CVCalendar/CVCalendar/issues/210)
- Inconsistent usage of custom color's [\#209](https://github.com/CVCalendar/CVCalendar/issues/209)
- There are serious autoLayout issues with this calendar [\#208](https://github.com/CVCalendar/CVCalendar/issues/208)
- How do you turn off the circles on touching of the days? No delegate methods get fired for CVCalendarViewDelegate so daySelected doesn't work at all.  [\#202](https://github.com/CVCalendar/CVCalendar/issues/202)
- First week of 2016 selection bug [\#201](https://github.com/CVCalendar/CVCalendar/issues/201)
- Remove localisation for months & days [\#200](https://github.com/CVCalendar/CVCalendar/issues/200)
- Backwards-incompatible changes should have a major version bump, not just a patch. [\#199](https://github.com/CVCalendar/CVCalendar/issues/199)
- Supplementary Views on wrong DayView Cell [\#198](https://github.com/CVCalendar/CVCalendar/issues/198)
- About shouldAutoSelectDayOnMonthChange and Today button [\#196](https://github.com/CVCalendar/CVCalendar/issues/196)
- Date selection after dot marker setup [\#194](https://github.com/CVCalendar/CVCalendar/issues/194)
- Error Returning Date [\#193](https://github.com/CVCalendar/CVCalendar/issues/193)
- Dots changing Color [\#192](https://github.com/CVCalendar/CVCalendar/issues/192)
- How to change the text color of a non-selected date [\#191](https://github.com/CVCalendar/CVCalendar/issues/191)
- animationDidFinish is never true on didSelectDayView method [\#189](https://github.com/CVCalendar/CVCalendar/issues/189)
- Circle Size of Selected Day [\#186](https://github.com/CVCalendar/CVCalendar/issues/186)
- Improve code for snapping back to current date animation [\#185](https://github.com/CVCalendar/CVCalendar/issues/185)
- Only allow a date range to be displayed? [\#178](https://github.com/CVCalendar/CVCalendar/issues/178)
- Monthly calendar view is out of bounds in CVCalendarView and misaligned with MenuView [\#176](https://github.com/CVCalendar/CVCalendar/issues/176)
- How to disable day selection entirely? [\#174](https://github.com/CVCalendar/CVCalendar/issues/174)
- No implementation of dotMarker:colorOnDayView creates fatal error [\#173](https://github.com/CVCalendar/CVCalendar/issues/173)
- How to gray out / prevent selection of past days ? [\#172](https://github.com/CVCalendar/CVCalendar/issues/172)
- didSelectDayView not called anymore [\#171](https://github.com/CVCalendar/CVCalendar/issues/171)
- Is there a way of getting six rows worth of days \(permanently\) rather than 5? [\#167](https://github.com/CVCalendar/CVCalendar/issues/167)
- Changing firstWeekday\(\) messes up with matchedWeeks calculation [\#162](https://github.com/CVCalendar/CVCalendar/issues/162)
- Lose selected date scrolling from month to month [\#161](https://github.com/CVCalendar/CVCalendar/issues/161)
- func dotMarker\(shouldShowOnDayView dayView: CVCalendarDayView\) -\> Bool  This function seems has some bugs [\#153](https://github.com/CVCalendar/CVCalendar/issues/153)
- how to start the calendar in a preset date ¿? [\#150](https://github.com/CVCalendar/CVCalendar/issues/150)
- When I select a day, it executes the functions twice.  [\#148](https://github.com/CVCalendar/CVCalendar/issues/148)
- What is the logic for return dates in shouldShowOnDayView [\#146](https://github.com/CVCalendar/CVCalendar/issues/146)
- Problem while switching between week view and month view [\#144](https://github.com/CVCalendar/CVCalendar/issues/144)
- Is there a way to set background color for the "out" days view? [\#142](https://github.com/CVCalendar/CVCalendar/issues/142)
- Customize color on specific dates in calendar [\#139](https://github.com/CVCalendar/CVCalendar/issues/139)
- Daily Calendar [\#135](https://github.com/CVCalendar/CVCalendar/issues/135)
- CVCalendarView does not appear when displayed in a scrollview [\#128](https://github.com/CVCalendar/CVCalendar/issues/128)
- Don't call didSelectDayView for current day on month change? [\#122](https://github.com/CVCalendar/CVCalendar/issues/122)
- How exactly DayView size is calculated \[Help\] [\#110](https://github.com/CVCalendar/CVCalendar/issues/110)
- Disable automatic transition when clicking dayView [\#107](https://github.com/CVCalendar/CVCalendar/issues/107)

**Merged pull requests:**

- fix: skip duplicates when navigatie between weeks [\#552](https://github.com/CVCalendar/CVCalendar/pull/552) ([xPutnikx](https://github.com/xPutnikx))
- fix: use proper calendar to calculate next month for weekview [\#551](https://github.com/CVCalendar/CVCalendar/pull/551) ([xPutnikx](https://github.com/xPutnikx))
- fix: remove setup labels for refresh month [\#550](https://github.com/CVCalendar/CVCalendar/pull/550) ([xPutnikx](https://github.com/xPutnikx))
- Fix toggle day for a week view, in case when any date wasn't selected yet [\#549](https://github.com/CVCalendar/CVCalendar/pull/549) ([xPutnikx](https://github.com/xPutnikx))
- Pass calendar to convertedDate when receiving a touch in a day view [\#541](https://github.com/CVCalendar/CVCalendar/pull/541) ([gabmarfer](https://github.com/gabmarfer))
- Update xcode build env in travis yml [\#540](https://github.com/CVCalendar/CVCalendar/pull/540) ([elsesiy](https://github.com/elsesiy))
- Swift4.2 [\#538](https://github.com/CVCalendar/CVCalendar/pull/538) ([KarlChow92](https://github.com/KarlChow92))
- Enhance/ci [\#508](https://github.com/CVCalendar/CVCalendar/pull/508) ([elsesiy](https://github.com/elsesiy))
- fixed selected day losing color after calling refreshPresentedMonth\(\) [\#507](https://github.com/CVCalendar/CVCalendar/pull/507) ([WaffleCohn](https://github.com/WaffleCohn))
...
- Initialize month view with calendar view's presented date, if availab… [\#489](https://github.com/CVCalendar/CVCalendar/pull/489) ([paulyhedral](https://github.com/paulyhedral))
...
- Change from nil to a new value is a update [\#389](https://github.com/CVCalendar/CVCalendar/pull/389) ([IsanHu](https://github.com/IsanHu))
...
- When the newly set presentedDate equals to the old presentedDate, presentedDate don’t update [\#387](https://github.com/CVCalendar/CVCalendar/pull/387) ([IsanHu](https://github.com/IsanHu))
...
- Added the ability to change the weekday symbol type for the CVCalendarMenu [\#127](https://github.com/CVCalendar/CVCalendar/pull/127) ([roymckenzie](https://github.com/roymckenzie))
...
- Spelling error [\#43](https://github.com/CVCalendar/CVCalendar/issues/43)
- CVDate with month = 0 and month = 13 [\#23](https://github.com/CVCalendar/CVCalendar/issues/23)
- Animating between CVCalendarViewModes [\#17](https://github.com/CVCalendar/CVCalendar/issues/17)
